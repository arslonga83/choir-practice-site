...
getMissionTracksHtml()  

export async function getMissionTracksHtml() {

    const response = await fetch('missionTracks')
    const recordingsData = await response.json()

    const missionTracks = document.getElementById('missionTracks')
    let missionTracksHtml = ``
    ...
    missionTracks.innerHTML += missionTracksHtml 
