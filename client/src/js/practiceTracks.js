      ...
      // }
        ...
        practiceTracksHtml += ` 
          <div class="card text-center col-lg-5 col-md-12 rounded bg-secondary text-white mt-5" >
            ...
            ${item.track3 ? `${track3Html}` : ``}
            ${item.track4 ? `${track4Html}` : ``}
            ${item.track5 ? `${track5Html}` : ``}
            ${item.track6 ? `${track6Html}` : ``}
            ${item.track7 ? `${track7Html}` : ``}
            ${item.track8 ? `${track8Html}` : ``}
            ${item.track9 ? `${track9Html}` : ``}
            </div>
          </div>`
      }
